...
const nodes: Node[] = [
  ...
  { id: '36', data: { label: 'Tablouri unidimensionale' }, position: { x: 300+300, y: 200 } },
    { id: '37', data: { label: 'Introducere' }, position: { x: 300+300, y: 300 } },
    { id: '38', data: { label: 'Inserări și ștergeri' }, position: { x: 300+300, y: 400 } },
    { id: '39', data: { label: 'Verificarea unor proprietăți' }, position: { x: 300+300, y: 500 } },
    { id: '40', data: { label: 'Sortarea vectorilor' }, position: { x: 300+300, y: 600 } },
    { id: '41', data: { label: 'Interclasare' }, position: { x: 300+300, y: 700 } },
    { id: '42', data: { label: 'Secvențe în vectori' }, position: { x: 300+300, y: 800 } },
      { id: '43', data: { label: 'Sume parțiale' }, position: { x: 100+300, y: 900 } },
      { id: '44', data: { label: 'Secvență de sumă maximă' }, position: { x: 300+300, y: 900 } },
      { id: '45', data: { label: 'Șmenul lui Mars - Difference Arrays' }, position: { x: 500+300, y: 900 } },
    { id: '46', data: { label: 'Căutarea binară' }, position: { x: 300+300, y: 1000 } },
    { id: '47', data: { label: 'Vectori caracteristici și de frecvență' }, position: { x: 300+300, y: 1100 } },
      { id: '48', data: { label: 'Ciurul lui Eratostene' }, position: { x: 150+300, y: 1200 } },
      { id: '49', data: { label: 'Algoritmi de tipul Ciurul lui Eratostene' }, position: { x: 450+300, y: 1200 } },
    { id: '50', data: { label: 'Aritmetica numerelor mari' }, position: { x: 300+300, y: 1300 } },
    { id: '51', data: { label: 'Divizibilitate' }, position: { x: 300+300, y: 1400 } },
